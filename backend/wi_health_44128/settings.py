"""
Django settings for wi_health_44128 project.
...
ROOT_URLCONF = 'wi_health_44128.urls'
...
WSGI_APPLICATION = 'wi_health_44128.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wi_health_44128 API",
    "DESCRIPTION": "API documentation for wi_health_44128 App",
    "VERSION": "v1",
}
